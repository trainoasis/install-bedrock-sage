...
#
#PROJECT_PATH="/Users/wiwacloud/Dev/MESI" # absolute path without trailing slash
...
then
	...
	printf "==> Enter Root WP project path where your project will reside. For example /Users/myself/Sites: \n -- no spaces/weird chars -- \n -- absolute path WITHOUT TRAILING SLASH\nPATH: "
	read PROJECT_PATH
else
